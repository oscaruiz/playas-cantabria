...
export const en = {
  ...
  'home.datosDeCache': 'Saved from your last visit',
  'home.datosDeCacheAccion': 'Tap to refresh',
  'home.datosDeCacheBuscando': 'Fetching the current ones…',
  ...
  'detalle.pronostico.ariaHoraLluvia': 'At {hora}: rain expected, {temp} degrees, wind {viento} metres per second',
  ...
  'ventana.mejor': 'Best time to go: {inicio}–{fin}',
  ...
  'ventana.hastaFin': 'Good time until {fin}',
  'ventana.motivo.sinLluvia': 'Chosen as the stretch with no rain expected',
  'ventana.motivo.despeja': 'Chosen as the clearest hours',
  'ventana.motivo.subeTemperatura': 'Chosen as the warmest hours',
  'ventana.motivo.amainaViento': 'Chosen as the hours with the least wind',
  'ventana.sinCambios': 'Nothing turning worse before the day closes',
  'detalle.pronostico.tituloRestoDia': 'Rest of today ({dia})',
  'detalle.pronostico.horasAnteriores': 'Show earlier hours',
  'detalle.pronostico.horasSiguientes': 'Show more hours',
