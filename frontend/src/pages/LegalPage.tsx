...
const EnlacesFuentes: React.FC = () => (
  <ul>
    ...
    <li>
      ...
      <a href="https://open-meteo.com/" target="_blank" rel="noopener noreferrer">Datos meteorológicos de Open-Meteo, adaptados para las recomendaciones de Playas Cantabria.</a>{' '}
    ...
    <IonPage className="legal-page">
      ...
      <header className="legal-header">
        <div className="legal-header-izq">
          ...
          <Link to="/" className="legal-home">Playas Cantabria</Link>
        </div>
        <HeaderActions />
      </header>
